...
import os
# from image_encode_rest18 import *
from image_encode_eff import *
...
vision_feature_dim = 1024 #加上了text
    ...
    for epoch_idx in tglobal:
        ...
        with tqdm(dataloader, desc='Batch', leave=False) as tepoch:
            for nbatch in tepoch:
                ...
                image_features = nets['vision_encoder'](nimage,text)
